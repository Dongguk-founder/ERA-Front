...
class routeElementsAdapter(private var items: ArrayList<ElementListLayout>) : RecyclerView.Adapter<routeElementsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Log.e("COUNT", "${items[position].start}")


        if(items[position].mode == null){
